...
export const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="overlay" style={{ backgroundColor: "#ffffff" }}>
        <div className="window" style={{ width: "400px", backgroundColor: "#ffffff", color: "#003366" }}>
          <div className="titlebar" style={{ backgroundColor: "#E6F0FA", color: "#003366" }}>
          ...
          <div className="window-content">
            <div className="flex flex-col items-center justify-center gap-4" style={{ padding: "20px 0" }}>
              <div className="spinner" style={{ borderColor: "#003366" }}></div>
              <p>Please wait...</p>
            </div>
          </div>
        </div>
  ...
  if (!requiredRole || !requiredRole.toLowerCase().includes(user?.role.toLowerCase() ?? "")) {
    return (
      <div className="overlay" style={{ backgroundColor: "#ffffff" }}>
        <div className="window" style={{ width: "450px", backgroundColor: "#ffffff", color: "#003366" }}>
          <div className="titlebar" style={{ backgroundColor: "#E6F0FA", color: "#003366" }}>
            <div className="titlebar-icon">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
          ...
          <div className="window-content" style={{ backgroundColor: "#ffffff" }}>
            <div className="flex flex-col items-center text-center gap-4" style={{ padding: "20px 0" }}>
              <div style={{ color: "#003366", opacity: 0.95 }}>
              ...
              <h2 style={{ color: "#003366" }}>Access Denied</h2>
              ...
              {user?.role && (
                <p style={{ color: "#005A9E", fontWeight: 600 }}>
                  Your role: {user.role}
                </p>
              )}
              <button
